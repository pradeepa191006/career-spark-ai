  ...
  return (
    <div className="glass-card p-6 rounded-2xl space-y-4 animate-pulse">
      ...
      <div className="space-y-3">
        <div className="grid grid-cols-4 gap-4 pb-2 border-b border-slate-200 dark:border-[#143D32]">
...
export const SkeletonResumePreview: React.FC = () => {
  return (
    <div className="w-full aspect-[1/1.414] bg-slate-100 dark:bg-[#071C17] border border-slate-200 dark:border-[#143D32] rounded-2xl p-8 space-y-6 animate-pulse">
      {/* Header */}
